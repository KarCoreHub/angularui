...
namespace AuthenticationService.Test
{
    public class AuthControllerTest
    {
        ...
        public void RegisterShouldReturnCreatedResult()
        {
            ...
            User user = new User { UserId = "sachin", Password = "admin123", FirstName = "Sachin", LastName = "Gupta", AddedDate = new DateTime() };
        ...
        public void LoginShouldReturnOkResult()
        {
           ...
           var actionReult = Assert.IsType<OkObjectResult>(actual);
            ...
            //Assert.Equal((string) actionReult.Value);
            Assert.IsType<string>(actionReult.Value);
        }
